...
public class NotificationUtils {
    ...
    //      TODO (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent pIntent = PendingIntent.getService(context, ACTION_IGNORE_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    //      TODO (9) Create an Action for the user to ignore the notification (and dismiss it)
        android.support.v7.app.NotificationCompat.Action rAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"No, thanks..",pIntent);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pIntent = PendingIntent.getService(context, ACTION_DRINK_PENDING_INTENT_ID, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,"I did it!",pIntent);
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(
                context, WATER_REMINDER_PENDING_INTENT_ID, startActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
