...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            BatteryManager mgr = (BatteryManager) getSystemService(BATTERY_SERVICE);
            showCharging(mgr.isCharging());
        }else{
            ...
            boolean charged = (status == BatteryManager.BATTERY_STATUS_CHARGING) || (status == BatteryManager.BATTERY_STATUS_FULL);
