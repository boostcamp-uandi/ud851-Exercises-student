...
public class NotificationUtils {
    ...
    final static int PENDINGINTENT_ID = 100;
    final static int NOTIFICATION_ID = 200;
    ...
    public static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, PENDINGINTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
