...
public class MainActivity extends AppCompatActivity implements
    ...
    private void showCharging(boolean charged){
        if(charged)     mChargingImageView.setImageResource(R.drawable.ic_power_pink_80px);
        else    mChargingImageView.setImageResource(R.drawable.ic_local_drink_grey_120px);
    }
    ...
    private class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean charged = action.equals(Intent.ACTION_POWER_CONNECTED);
            showCharging(charged);
