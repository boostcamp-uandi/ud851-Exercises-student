...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loader loader = getSupportLoaderManager().initLoader(GITHUB_SEARCH_LOADER, null, this);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery.equals("")) {
            Toast.makeText(MainActivity.this, "Nothing in mSearchBoxEditText", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(loader == null)
            loader = loaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        else
            loader = loaderManager.restartLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
    }
