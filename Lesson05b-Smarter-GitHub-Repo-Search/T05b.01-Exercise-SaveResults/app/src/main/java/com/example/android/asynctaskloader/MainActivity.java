...
public class MainActivity extends AppCompatActivity {
    ...
    static final String queryURL = "QUERY_URL";

    // TODO (2) Create a static final key to store the search's raw JSON
    static final String rawJSON = "RAW_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(queryURL)) {
                String url = savedInstanceState.getString(queryURL);
                mUrlDisplayTextView.setText(url);
            }
            if(savedInstanceState.containsKey(rawJSON)) {
                String result = savedInstanceState.getString(rawJSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(queryURL, urlString);
        ...
        outState.putString(rawJSON, searchResultString);
