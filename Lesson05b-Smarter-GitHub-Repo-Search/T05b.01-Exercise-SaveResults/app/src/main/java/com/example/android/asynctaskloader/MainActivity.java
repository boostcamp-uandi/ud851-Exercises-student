...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String search_key = "JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            String queryUrl = savedInstanceState.getString(query_key);
            String JsonSearchResults = savedInstanceState.getString(search_key);

            mUrlDisplayTextView.setText(queryUrl);
            mSearchResultsTextView.setText(JsonSearchResults);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(search_key, JsonSearchResults);
    }
