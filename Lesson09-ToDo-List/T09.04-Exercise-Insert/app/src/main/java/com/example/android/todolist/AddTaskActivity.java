...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        String userInput = ((EditText)findViewById(R.id.editTextTaskDescription)).getText().toString();
        ...
        contentValues.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, userInput);
