...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int DIR_TASKS = 100;
    public static final int ITEMS_TASKS = 101;

    // TODO (3) Declare a static variable for the Uri matcher that you construct
    private static UriMatcher uriMatcher = buildUriMatch();
    ...
    private static UriMatcher buildUriMatch(){
        ...
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, DIR_TASKS);
        uriMatcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", ITEMS_TASKS);
