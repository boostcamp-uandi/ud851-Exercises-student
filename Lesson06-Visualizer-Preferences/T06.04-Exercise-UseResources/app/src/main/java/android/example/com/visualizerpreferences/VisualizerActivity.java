...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        boolean prefShowBassDefaultValue = getResources().getBoolean(R.bool.pref_show_bass_default);

        mVisualizerView.setShowBass(sharedPreferences.getBoolean(showBassKey, prefShowBassDefaultValue));
