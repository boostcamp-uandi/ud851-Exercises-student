...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadSizeFromPreference(SharedPreferences sharedPref){
        float size = Float.parseFloat(sharedPref.getString(getString(R.string.pref_size_key), getString(R.string.pref_size_default)));
