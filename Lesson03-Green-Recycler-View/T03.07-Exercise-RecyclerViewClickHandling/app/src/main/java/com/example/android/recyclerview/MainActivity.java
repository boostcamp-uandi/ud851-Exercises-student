...
public class MainActivity extends AppCompatActivity implements GreenAdapter.ListItemClickLister {
    ...
    public void onListItemClick(int itemNum) {
        ...
        mToast = Toast.makeText(this, itemNum + " clicked", Toast.LENGTH_SHORT);
        mToast.show();
