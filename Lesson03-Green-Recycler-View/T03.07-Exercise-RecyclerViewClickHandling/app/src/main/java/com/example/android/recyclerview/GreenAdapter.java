...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    private final ListItemClickLister mOnClickListener;
    ...
    public interface ListItemClickLister {
        ...
        public void onListItemClick(int itemNum);
    }
     ...
     */
    public GreenAdapter(int numberOfItems, ListItemClickLister listItemClickLister) {
        mNumberItems = numberOfItems;
        viewHolderCount = 0;
        mOnClickListener = listItemClickLister;
    }
