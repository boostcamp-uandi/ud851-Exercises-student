...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentThatStartedThisMethod = getIntent();

        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if(intentThatStartedThisMethod.hasExtra(Intent.EXTRA_TEXT)){
            // TODO (5) If the Intent contains the correct extra, retrieve the text
            String textEntered = intentThatStartedThisMethod.getStringExtra(Intent.EXTRA_TEXT);
