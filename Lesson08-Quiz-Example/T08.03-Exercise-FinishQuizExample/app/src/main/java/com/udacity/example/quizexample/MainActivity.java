...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        def_tv = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if(mData != null){
            ...
            def_tv.setVisibility(View.INVISIBLE);
            mButton.setText(getString(R.string.show_definition));
            word_tv.setText(mData.getString(wordCol));
            def_tv.setText(mData.getString(defCol));
